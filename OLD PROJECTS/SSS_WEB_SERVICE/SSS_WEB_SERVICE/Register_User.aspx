<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register_User.aspx.cs" Inherits="SSS_WEB_SERVICE.Register_User" %>
					...
					<div class="row fullscreen d-flex justify-content-center align-items-center">
						<div class="banner-content col-lg-9 col-md-12 justify-content-center">
							    <form id="form1" runat="server">
									<div>																
										<asp:TextBox ID="TextBox1"  style="width:500px"  PLACEHOLDER="USER NAME" runat="server"></asp:TextBox>
										<asp:Button style="width:500px" class="primary-btn header-btn text-uppercase mt-10" ID="Button1" runat="server" OnClick="Button1_Click" Text="ADD USER" /><br/><br/>
