...
public class Update_Train_Data_VN {
	public Update_Train_Data_VN()
	{
	}
	public String do_The_Work(String URL,String User_ID)
	{
		 String address = "";
	        try {
	            ...
	            final String SOAP_ACTION = "http://tempuri.org/UPDATE_TRAIN_DATA_VN";
	            final String METHOD_NAME = "UPDATE_TRAIN_DATA_VN";
