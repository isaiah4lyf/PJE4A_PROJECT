...
public class Update_Accuracy_Users {
	public Update_Accuracy_Users()
	{
	}
	public String do_The_Work(String URL,String User_ID, String Prediction_Accuracy_Images, String Validation_Accuracy_Images, String Prediction_Accuracy_VN, String Validation_Accuracy_VN)
	{
		 String address = "";
	        try 
	        {
	            ...
	            final String SOAP_ACTION = "http://tempuri.org/UPDATE_ACCURACY_USERS";
	            final String METHOD_NAME = "UPDATE_ACCURACY_USERS";
