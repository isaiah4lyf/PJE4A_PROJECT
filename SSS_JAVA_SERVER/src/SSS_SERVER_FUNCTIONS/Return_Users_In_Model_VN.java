...
public class Return_Users_In_Model_VN {
	public Return_Users_In_Model_VN()
	{
	}
	...
	public String[] Do_The_Work(String URL,String Model_ID)
	{
        ...
        final String SOAP_ACTION = "http://tempuri.org/RETURN_USERS_IN_MODEL_VN";
        final String METHOD_NAME = "RETURN_USERS_IN_MODEL_VN";
