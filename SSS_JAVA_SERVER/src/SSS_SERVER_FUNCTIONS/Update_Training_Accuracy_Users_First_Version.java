...
public class Update_Training_Accuracy_Users_First_Version {
	public Update_Training_Accuracy_Users_First_Version()
	{
	}
	public String do_The_Work(String URL,String Model_ID, String Validation_Accuracy_Images, String Validation_Accuracy_VN)
	{
		 String address = "";
	        try 
	        {
	            ...
	            final String SOAP_ACTION = "http://tempuri.org/UPDATE_TRAINING_ACCURACY_USERS_FIRST_VERSION";
	            final String METHOD_NAME = "UPDATE_TRAINING_ACCURACY_USERS_FIRST_VERSION";
